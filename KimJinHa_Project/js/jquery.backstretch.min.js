 ...
 * Fork of improvements - by Daniel Cohen Gindi (danielgindi@gmail.com) Licensed
 * MIT
 */
!function (a, b, c) {
    "use strict";
    ...
    a.fn.backstretch = function (d, e) {
        ...
        return this.each(function (b) {
            ...
            if (i) {
                ...
                i.hasOwnProperty("destroy") && i.destroy(!0)
            }
            if (!d || d && 0 === d.length) {
                ...
                k && "none" !== k
                    ...
                    : a.error(
                        "No images were supplied for Backstretch, or element must have a CSS-defined ba" +
                        "ckground image."
                    )
            }
            i = new n(this, d, e || {}),
    ...
    var f = {
        ...
        g = function () {
            var c = function (a) {
                ...
                d = function (a, c, d) {
                    for (var e, f, g = b.devicePixelRatio || 1, h = q(), i = (
                        r(),
                        c > a
                            ? "portrait"
                            : a > c
                        ...
                        f.pixelRatio && "auto" !== f.pixelRatio && parseFloat(f.pixelRatio) !== g || f.deviceOrientation && f.deviceOrientation !== h || f.windowOrientation && f.windowOrientation !== h || f.orientation && f.orientation !== i || (j = k, e = a, "auto" === f.pixelRatio && (a *= g), !(f.width >= e))
                    ); k++) 
                    ;
        ...
        i = function (b, c, d, e, f) {
            ...
            return function b(c, d, e, f, g) {
                if ("undefined" != typeof c) {
                    a.isArray(c) || (c = [c]),
                    arguments.length < 5 && "function" == typeof arguments[arguments.length - 1] && (
                        g = arguments[arguments.length - 1]
                    ),
                    d = "function" != typeof d && d
                        ? d
                        : 0,
                    e = "function" == typeof e || !e || e < 0
                        ? c.length
                        : Math.min(e, c.length),
        ...
        k = function (a, e) {
            return (a.centeredX || a.centeredY) && (
                b.console && b.console.log && b.console.log(
                    "jquery.backstretch: `centeredX`/`centeredY` is deprecated, please use `alignX`" +
                    "/`alignY`"
                ),
            ...
            a.speed !== c && (
                b.console && b.console.log && b.console.log("jquery.backstretch: `speed` is deprecated, please use `transitionDuration`"),
            ...
            a.fade !== c && (a.transitionDuration = a.fade, a.transition = "fade"),
            a.scale && (a.scale = d(a.scale)),
            l(a)
        },
        l = function (a, b) {
            return "left" === a.alignX
                ? a.alignX = 0
                : "center" === a.alignX
                    ? a.alignX = .5
                    : "right" === a.alignX
        ...
        n = function (c, d, e) {
            ...
            this.images = g(
                this.options.alwaysTestWindowResolution
                    ? h
                    : this.$root,
                this.originalImages
            ),
            ...
            if (
                this.$wrap = l.length
                    ? l
                    : a('<div class="backstretch"></div>').css(
            ...
            h
                ...
                .on("orientationchange.backstretch", a.proxy(function () {
    ...
    n.prototype = {
        resize: function () {
            try {
                ...
                if ((f !== this._lastResizeContainerWidth || h !== this._lastResizeContainerHeight) && (Math.abs(j - 1) >= l || isNaN(j) || Math.abs(k - 1) >= l || isNaN(k)) && (
                ...
                var n,
                    ...
                    t = this
                        ...
                        .data("height"),
                    u = s / t || 1,
                    v = this._currentImage.alignX === c
                        ? this.options.alignX
                        : this._currentImage.alignX,
                    w = this._currentImage.alignY === c
                        ? this.options.alignY
                ...
                this.options.bypassCss || this
                    ...
                    .each(function () {
                        var b = a(this);
                        b
                            .find("img,video,iframe")
                            .css(p)
                    });
                var z = a.Event("backstretch.resize", {relatedTarget: this.$container[0]});
                this
                    .$container
                    .trigger(z, this)
            } catch (a) {}
        ...
        show: function (b, d) {
            if (!(Math.abs(b) > this.images.length - 1)) {
                ...
                e
                    .$container
                    .trigger(a.Event("backstretch.before", j), [e, b]),
                this.index = b;
                var k = e.images[b];
                        ...
                        function (f) {
                            ...
                            var q = function (a) {
                                ...
                                u = function () {
                                    ...
                                    e.options.bypassCss || e.isBody || e
                                        .$container
                                        .css("background-image", "none"),
                                    a(["after", "show"]).each(function () {
                                        e
                                            .$container
                                            .trigger(a.Event("backstretch." + this, j), [e, b])
                                    }),
                                    l && e
                                        .videoWrapper
                                        .play()
        ...
        cycle: function () {
            if (this.images.length > 1) {
                ...
                if (c) {
                    ...
                    this
                        .$item
                        .on("error.cycle initerror.cycle", a.proxy(d, this))
                }
                c && !this._currentImage.duration
                    ? this
                        .$item
                        .on("ended.cycle", a.proxy(d, this))
    ...
    p.prototype.init = function (d) {
        ...
        if (
            ...
            g.ytId = d
                .url
                .match(e)[2];
            var j = "https://www.youtube.com/embed/" + g.ytId + "?rel=0&autoplay=0&showinfo" +
                    "=0&controls=0&modestbranding=1&cc_load_policy=0&disablekb=1&iv_load_policy=3&l" +
                    "oop=0&enablejsapi=1&origin=" + encodeURIComponent(b.location.origin);
        ...
        var g = new d.Player(c.video, {
            events: {
                onReady: function () {
                    ...
                    e || (c.$video[0].parentNode === f[0] && c.$video.detach(), f.remove()),
                    c.ytReady = !0,
    ...
    p.loadYoutubeAPI = function () {
        if (!b.YT) {
            a("script[src*=www\\.youtube\\.com\\/iframe_api]").length || a(
    ...
    var q = function () {
        ...
        s = function () {
            var a = navigator.userAgent,
                ...
                k = !!j && j[1];
            return !(
                (c.indexOf("iPhone") > -1 || c.indexOf("iPad") > -1 || c.indexOf("iPod") > -1) && e && e < 534 || b.operamini && "[object OperaMini]" === {}.toString.call(b.operamini) || h && i < 7458 || a.indexOf("Android") > -1 && e && e < 533 || g && g < 6 || "palmGetResource" in b && e && e < 534 || a.indexOf("MeeGo") > -1 && a.indexOf("NokiaBrowser/8.5.0") > -1 || k && k <= 6
            )
        }()
}(jQuery, window);